...
func (x *ProtocStudent) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ProtocStudent) ProtoMessage() {}

func (x *ProtocStudent) ProtoReflect() protoreflect.Message {
	mi := &file_student_proto_msgTypes[0]
...
// Deprecated: Use ProtocStudent.ProtoReflect.Descriptor instead.
func (*ProtocStudent) Descriptor() ([]byte, []int) {
	return file_student_proto_rawDescGZIP(), []int{0}
}

func (x *ProtocStudent) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *ProtocStudent) GetMale() bool {
	if x != nil {
		return x.Male
	}
	return false
...
func (x *ProtocStudent) GetScores() []int32 {
	if x != nil {
		return x.Scores
	}
	return nil
...
var file_student_proto_rawDesc = []byte{
	...
	0x03, 0x72, 0x70, 0x63, 0x22, 0x4f, 0x0a, 0x0d, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x63, 0x53, 0x74,
	...
	0x63, 0x6f, 0x72, 0x65, 0x73, 0x42, 0x09, 0x5a, 0x07, 0x61, 0x61, 0x61, 0x2f, 0x62, 0x62, 0x62,
...
var file_student_proto_goTypes = []interface{}{
	(*ProtocStudent)(nil), // 0: rpc.ProtocStudent
}
