...
import com.dxtd.flink.sink.VideoOrderCounterSink;
...
//        );
        DataStream<VideoOrder2> ds = env.addSource(new VideoOrderSource());

        //transformation
       DataStream<Tuple2<String,Integer>> mapDS =  ds.map(new MapFunction<VideoOrder2, Tuple2<String,Integer>>() {
            @Override
...
//        });
       ...
       //分组
        ...
        //单机redis
        FlinkJedisPoolConfig conf = new FlinkJedisPoolConfig.Builder().setHost("192.168.11.12").setPort(6379).build();
