...
public class MysqlSink extends RichSinkFunction<VideoOrder2> {
    ...
    public void open(Configuration parameters) throws Exception {
        ...
        conn = DriverManager.getConnection("jdbc:mysql://192.168.11.12:3306/flink?useUnicode=true&characterEncoding=utf8&allowMultiQueries=true&serverTimezone=Asia/Shanghai", "root", "123456");
     ...
     */
    @Override
    public void invoke(VideoOrder2 value, Context context) throws Exception {
