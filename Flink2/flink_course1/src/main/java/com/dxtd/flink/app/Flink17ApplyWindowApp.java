...
public class Flink17ApplyWindowApp {
    ...
    public static void main(String[] args) throws Exception {
        ...
        SingleOutputStreamOperator<VideoOrder2> apply = keyByDS.window(TumblingProcessingTimeWindows.of(Time.seconds(5)))
                .apply(new WindowFunction<VideoOrder2, VideoOrder2, String, TimeWindow>() {
                    @Override
                    public void apply(String key, TimeWindow window, Iterable<VideoOrder2> input, Collector<VideoOrder2> out) throws Exception {

                        List<VideoOrder2> list = IteratorUtils.toList(input.iterator());
