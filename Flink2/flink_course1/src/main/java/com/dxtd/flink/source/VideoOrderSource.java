...
public class VideoOrderSource extends RichParallelSourceFunction<VideoOrder2> {
    ...
    public void run(SourceContext<VideoOrder2> ctx) throws Exception {
        ...
        while (flag){
            ...
            VideoOrder2 videoOrder = new VideoOrder2(id,title,money,userId,new Date());
