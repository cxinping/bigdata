...
def check_34_data():
    ...
    sql = 'select {columns_str} from 01_datamart_layer_007_h_cw_df.finance_meeting_bill where meet_lvl_name is not null and met_money is not null limit 100'.format(
