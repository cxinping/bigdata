...
def task1(coefficient):
    ...
    analyze_no_plane_data(coefficient=coefficient)  # 执行检查点14 no_plane 的数据共耗时 4559 sec
...
def task2(coefficient):
    ...
    analyze_plane_data(coefficient=coefficient)  # 执行检查点14 plane 的数据共耗时 5097 sec
