...
def demo5():
    ...
    records = prod_execute_sql(conn_type='prod', sqltype='insert', sql=sql)

def demo6():
    sql1 = '''
    update 01_datamart_layer_007_h_cw_df.finance_unusual set unusual_point='同地区同期间住宿价格对比分析', unusual_content='关注相同或临近期间，同一费用发生地，不同人员或企业的住宿费偏离平均值或者大多数人费用分布区间的情况。', unusual_shell='# -*- coding\: utf-8 -*-
